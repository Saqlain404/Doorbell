          ...
          <div className="row border px-md-3 px-2 py-md-4 py-3 bg-white">
            <div className="col-12 content_pagess_main">
              ...
              <p>
                ...
                to it, still belong to Star Importers. This app is allowed to
                sell Tobacco Licenced Products..Please upload proper documents
                and licences for valid purchase. Star Importers is committed to
              ...
              <p>
                The Star Importers app stores and processes personal data that
                ...
                security features and it could mean that the Star Importers app
                won’t work properly or at all. Link to Terms and Conditions of
                third-party service providers used by the app
              </p>
              <h2>Firebase Crashlytics</h2>
              <p>
                You should be aware that there are certain things that Star
                Importers will not take responsibility for. Certain functions of
                the app will require the app to have an active internet
                connection. The connection can be Wi-Fi or provided by your
                mobile network provider, but Star Importers cannot take
              ...
              <p>
                ...
                and you can’t turn it on to avail the Service, Star Importers
                cannot accept responsibility.
              </p>
              <p>
                With respect to Star Importers’s responsibility for your use of
                ...
                information to us so that we can make it available to you. Star
                Importers accepts no liability for any loss, direct or indirect,
              ...
              <p>
                ...
                Star Importers does not promise that it will always update the
